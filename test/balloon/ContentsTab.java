...
public class ContentsTab extends JPanel {
    ...
    public ContentsTab() {
        ...
        contents1.setIcon(new ImageIcon(CompleteExample.class.getResource("/balloon/frameIcon.png")));
        ...
        comp2.setIcon(new ImageIcon(CompleteExample.class.getResource("/balloon/frameIcon.png")));
        panel2.add(comp2);
