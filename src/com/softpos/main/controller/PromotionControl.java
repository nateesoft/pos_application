...
import com.softpos.webapp.promotion.DiscountControl;
import com.softpos.webapp.promotion.PromotionConstant;
import com.softpos.webapp.promotion.TPromotion2;
import com.softpos.webapp.promotion.TPromotion3;
import com.softpos.webapp.promotion.TPromotion4;
import com.softpos.webapp.promotion.TPromotion5;
import com.softpos.webapp.promotion.TPromotionBean;
import com.softpos.webapp.promotion.TempPromotion;
...
public class PromotionControl {
    ...
    public void savePromotionItem(String PCode, String Table, String Index, double prDisc, double prBaht) {
        ...
        try {
            ...
            Statement stmt = mysql.getConnection().createStatement();
            int iUpdate = stmt.executeUpdate(sql);
            stmt.close();
        } catch (SQLException e) {
            MSG.ERR(null, e.getMessage());
        } finally {
                ...
                if (protab1 != null) {
                    ...
                    try {
                        ...
                        String sqlUpdatePro = "update balance set "
                                ...
                                + "and R_Void <> 'V' ";
                        Statement stmt = mysql.getConnection().createStatement();
                        int iUpdate = stmt.executeUpdate(sqlUpdatePro);
                        System.out.println(iUpdate + ":Update -P");

                        //Sale Promotion Type 1
                        if (protab1.getPType().equals(PromotionConstant.PROMOTION_TYPE_1)) {
                        ...
                        else if (protab1.getPType().equals(PromotionConstant.PROMOTION_TYPE_2)) {
                            // GET FROM Database
                            String sqlCheck = "select sum(R_Quan) R_Quan "
                                    ...
                                    + "and R_Void <> 'V' ";
                            Statement stmt1 = mysql.getConnection().createStatement();
                            ResultSet rs = stmt1.executeQuery(sqlCheck);
                            int Total_Qty = 0;
                        ...
                        else if (protab1.getPType().equals(PromotionConstant.PROMOTION_TYPE_3)) {
                            // GET FROM Database
                        ...
                        else if (protab1.getPType().equals(PromotionConstant.PROMOTION_TYPE_4)) {
                            // GET FROM Database
                        ...
                        else if (protab1.getPType().equals(PromotionConstant.PROMOTION_TYPE_5)) {
                            // GET FROM Database
                            String sqlCheck = "select sum(R_Quan) R_Quan, sum(R_Total) R_Total "
                                    + "from balance "
                                    + "where R_Table='" + balance.getR_Table() + "' "
        ...
        if (TAmount > 0) {
            ...
            try {
                ...
                String updateTableFile = "update tablefile set "
                        ...
                        + "where TCode='" + table + "'";
                Statement stmt = mysql.getConnection().createStatement();
                int update = stmt.executeUpdate(updateTableFile);
            } catch (SQLException e) {
                MSG.ERR(null, e.getMessage());
            } finally {
                mysql.close();
